...
본 프로젝트는 Django 웹 프레임워크와 PostgreSQL 데이터베이스를 기반으로 Docker Compose를 사용하여 multi-container 환경으로 진행하였습니다.

사용자는 자동 또는 수동 방식으로 로또를 구매하고 추첨 결과와 비교하여 당첨 여부를 확인할 수 있습니다.  
